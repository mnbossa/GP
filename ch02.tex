...
\section{Regression}
\label{sec:org588dcf2}
\subsection{Sampling from prior}
\label{sec:org267b359}
\begin{frame}[label={sec:org7f0b3e2}]{GP prior}
...
\begin{frame}[fragile,label={sec:org16805f4}]{Sampling from prior: Python code}
...
\begin{frame}[label={sec:org64b71b3}]{Random functions in 1D}
\begin{center}
...
\begin{frame}[fragile,label={sec:orgdb4749f}]{Different length scales}
 \begin{columns}
...
\begin{frame}[fragile,label={sec:org3f5be2a}]{Two dimensions}
 \begin{columns}
...
\label{sec:orgdd9bf75}
\begin{frame}[label={sec:org8de09d0}]{Computing posterior}
\begin{eqnarray*}
...
\begin{frame}[fragile,label={sec:org965f7c9}]{Python code}
 \begin{minted}[]{ipython}
...
\begin{frame}[fragile,label={sec:orgf7dfafd}]{scikit-learn}
 \begin{columns}
