...
\section{Regression}
\label{sec:org1e56278}
\subsection{Sampling from prior}
\label{sec:orgff85f5b}
\begin{frame}[label={sec:org7716c90}]{GP prior}
...
\begin{frame}[fragile,label={sec:orga64b8c0}]{Sampling from prior: Python code}
...
\begin{frame}[label={sec:orgdb50f61}]{Random functions in 1D}
\begin{center}
...
\begin{frame}[fragile,label={sec:org9702e2c}]{Different length scales}
 \begin{columns}
...
\begin{frame}[fragile,label={sec:org41badcd}]{Two dimensions}
 \begin{columns}
...
\label{sec:org4e46858}
\begin{frame}[label={sec:orgd710ae9}]{Computing posterior}
\begin{eqnarray*}
...
\begin{frame}[fragile,label={sec:orgdfdf0f8}]{Python code}
 \begin{minted}[]{ipython}
...
\begin{frame}[fragile,label={sec:orgaf909bf}]{Fitting some data}
 \begin{columns}
...
\label{sec:orgd2ed9ef}
\begin{frame}[fragile,label={sec:org34ca857}]{scikit-learn}
 \begin{columns}
...
\begin{frame}[fragile,label={sec:orgd1730e3}]{GPFlow}
 \begin{columns}
\begin{column}{0.43\columnwidth}
\begin{minted}[]{python}
import gpflow
...
\begin{frame}[label={sec:org7352c7a}]{PyMC3}
\end{frame}

\begin{frame}[label={sec:org2f5ab8a}]{Edward}
\end{frame}
