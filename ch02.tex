...
\section{Regression}
\label{sec:org1488376}
\subsection{Sampling from prior}
\label{sec:org2258d4b}
\begin{frame}[label={sec:org2857a18}]{GP prior}
...
\begin{frame}[fragile,label={sec:org6733ffb}]{Sampling from prior: Python code}
...
\begin{frame}[label={sec:orgac7ba93}]{Random functions in 1D}
\begin{center}
...
\begin{frame}[fragile,label={sec:orgb0b5bc7}]{Different length scales}
 \begin{columns}
...
\begin{frame}[fragile,label={sec:org4d51642}]{Two dimensions}
 \begin{columns}
...
\label{sec:org1c9a367}
\begin{frame}[fragile,label={sec:orgc5a806b}]{Computing posterior and sampling: Python code}
 \begin{minted}[]{ipython}
...
\begin{frame}[fragile,label={sec:org69f970c}]{Fitting some data}
 \begin{columns}
